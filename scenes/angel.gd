...
const DIALOG_LINES := [
	{"speaker": "Angel", "text": " "},
	{"speaker": "Angel", "text": "Environment is the most important thing "},
	{"speaker": "player", "text": "yes !"},
	{"speaker": "Angel", "text": "Hello player!"},
	{"speaker": "Angel", "text": "I would reccommend that we decrease the water usage and decrease the fertilizer use. The soil moisture is high"},
