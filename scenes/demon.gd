...
const DIALOG_LINES := [
	{"speaker": "demon", "text": " "},
	{"speaker": "demon", "text": "Hello , my brother in Wealth "},
	{"speaker": "player", "text": "Hello?"},
	{"speaker": "demon", "text": "I think you have met me for a purpose we both know it. "},
	{"speaker": "demon", "text": "You must increase water since we are in a hot country. We also should use fertilizers ."},
